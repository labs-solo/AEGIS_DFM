...
// TODO: the logic if correct can be used by the FRLM
...
library ReinvestLib {
    ...
    function compute(
        ...
        r.liquidity = LiquidityAmounts.getLiquidityForAmounts(
            sqrtP, TickMath.MIN_SQRT_PRICE, TickMath.MAX_SQRT_PRICE, r.bal0, r.bal1
        );
        ...
        r.use0 = SqrtPriceMath.getAmount0Delta(TickMath.MIN_SQRT_PRICE, TickMath.MAX_SQRT_PRICE, r.liquidity, true);
        r.use1 = SqrtPriceMath.getAmount1Delta(TickMath.MIN_SQRT_PRICE, TickMath.MAX_SQRT_PRICE, r.liquidity, true);
