...
import {IAllowanceTransfer} from "test/mocks/TestPermit2.sol";
import {IPositionDescriptor} from "v4-periphery/src/interfaces/IPositionDescriptor.sol";
import {IWETH9} from "v4-periphery/src/interfaces/external/IWETH9.sol";
import {IPositionManager} from "v4-periphery/src/interfaces/IPositionManager.sol";
import {NoDelegateCall} from "v4-core/src/NoDelegateCall.sol";
import {TestPermit2} from "test/mocks/TestPermit2.sol";
...
contract HookValidate is Test {
    ...
    function testValidateWithRealPoolManager() public {
        ...
        address hookAddr = Create2.computeAddress(salt, keccak256(abi.encodePacked(type(Spot).creationCode, args)), address(this));
        ...
        address payable actualHookAddr = payable(Create2.deploy(0, salt, abi.encodePacked(type(Spot).creationCode, args)));
